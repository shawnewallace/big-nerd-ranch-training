...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        // Make half-tansparent red the background color for the layer
        ...
        [_boxLayer setCornerRadius:10.0];
        [_boxLayer setShadowColor:[[UIColor blackColor] CGColor]];
        [_boxLayer setShadowOffset:CGSizeMake(0, 6)];
        [_boxLayer setShadowOpacity:1.0];
